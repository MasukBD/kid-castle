                ...
                <form onSubmit={handleAddProduct} className='w-full lg:w-11/12 mx-auto'>
                    <div className='flex flex-col lg:flex-row gap-4 lg:gap-9 mb-4'>
                        <div className='w-full'>
                            ...
                            <br />
                            <input className='w-full p-2 rounded-md bg-pink-50' type="text" name="ProductName" id="ProductName" required placeholder='ex:Ferrari F9 Venture' />
                        </div>
                        <div className='w-full'>
                    ...
                    <div className='flex flex-col lg:flex-row gap-4 lg:gap-9 mb-4'>
                        ...
                        <div className='w-full'>
                            ...
                            <br />
                            <input className='w-full p-2 rounded-md bg-pink-50' required placeholder='Available Products Quantity Pcs' type="number" min={1} name="quantity" id="quantity" />
                        </div>
                    </div>
                    <div className='flex flex-col lg:flex-row gap-4 lg:gap-9 mb-4'>
                        <div className='w-full'>
